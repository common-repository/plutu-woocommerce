...
class Plutu_Woocommerce_Mpgs_Payment_Gateway extends Plutu_Woocommerce_Payment_Gateway {
    ...
    public function __construct() {
        ...
        $this->method_title = __( 'Visa/Mastercard', 'plutu-woocommerce' );
        $this->method_description = __( 'Mastercard Payment Gateway Services', 'plutu-woocommerce' );
    ...
    public function callback_handler() {
        ...
        if( $this->is_signature_valid( $_GET, ['gateway', 'approved', 'canceled', 'invoice_no', 'amount', 'currency', 'transaction_id'] ) ) {
            if( $canceled ) {
