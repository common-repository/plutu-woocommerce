...
return [
    ...
    'title' => [
        ...
        'default' => __( 'Visa/Mastercard', 'plutu-woocommerce' ),
        'desc_tip' => false,
    ],
    'description' => [
        ...
        'default' => __( 'Pay by credit and debit card (Visa, Mastercard), after clicking "continue payment" you will be redirected to the payment service to complete your purchase securely.', 'plutu-woocommerce' ),
        'desc_tip' => false,
    ],
    'maximum_amount' => [
        'title' => __( 'Maximum amount', 'plutu-woocommerce' ),
        'type' => 'number',
    ...
    'minimum_amount' => [
        'title' => __( 'Minimum amount', 'plutu-woocommerce' ),
        'type' => 'number',
    ...
    'currency' => [
        ...
        'description' => __( 'The currency for the payment method should match the currency associated with your account in both Plutu and MPGS.', 'plutu-woocommerce' ),
        'type' => 'select',
        'class' => 'wc-enhanced-select',
        'options' => array_filter(get_woocommerce_currencies(), function( $code ) {
            return in_array($code, ['USD', 'EUR']);
