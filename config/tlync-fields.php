...
return [
    ...
    'title' => [
        ...
        'default' => __( 'T-lync', 'plutu-woocommerce' ),
        'desc_tip' => false,
    ],
    'description' => [
        'title' => __( 'Description', 'plutu-woocommerce' ),
        'type' => 'textarea',
        'default' => __( 'Pay via T-lync platform using Tadawul Cards, Sadad, Adfali, Local Bank Cards, and Mobicash. etc.', 'plutu-woocommerce' ),
